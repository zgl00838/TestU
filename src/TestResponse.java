...
public class TestResponse {
	...
	public static void main(String[] args) {
		String url = "http://47.90.9.181:82/wgws/OrderReceiptServlet";// 应用地址
		
		Map<String, String> map = new HashMap<String, String>();
		map.put("apName", "lcxx");
		map.put("apPassword", "lcxx88");
		//map.put("calledNumber", "15868230580");
		//map.put("content", "【绿城信息】你的验证码为54321，有效期2分钟。请填写验证码完成注册。");//用自己的内容白名单做测试
